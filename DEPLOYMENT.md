# Развертывание Python API Server с поддержкой обработки видео

## Обзор

Этот проект представляет собой API сервер на FastAPI с интеграцией библиотеки dive-color-corrector для обработки видео и изображений под водой. Сервер поддерживает:

- Обработку изображений для коррекции цветов
- Обработку видео с прогресс-баром
...
- Debian сервер с root доступом
- SSH доступ к серверу
- Обновленный файл `server_config.json` с данными сервера
